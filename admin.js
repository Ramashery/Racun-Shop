...
import {
    ...
    doc, getDoc, setDoc, updateDoc, deleteDoc, addDoc, terminate
...
async function loadPagesAndSettings() {
    try {
        const pageIds = ['home', 'catalog', 'blog-page', 'contacts', 'about', 'footer-nav'];
...
function fillPageFields(pageId, lang) {
    ...
    if (pageId === 'about') {
        ...
        setV('about-ogImageUrl',     gf.ogImageUrl     || '');
    }
