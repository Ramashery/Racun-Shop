...
window.savePageDoc = async function(pageId) {
    ...
    if (pageId === 'home') {
        ...
        localizedFields = {
            ...
            ctaButton:       getV('contacts-ctaButton'),   logisticsTerms:  getV('contacts-logisticsTerms'),
        ...
        globalFields.phone     = getV('contacts-phone');   globalFields.email     = getV('contacts-email');
        globalFields.ctaEmail  = getV('contacts-ctaEmail'); globalFields.mapsEmbed = getV('contacts-mapsEmbed');
        globalFields.ogImageUrl= getV('contacts-ogImageUrl'); globalFields.schemaOrg = getV('contacts-schemaOrg');
