...
function renderSlides(slides) {
    ...
    body.innerHTML = slides.map((s, i) => `
        <div class="slide-row" data-idx="${i}" style="margin-bottom:18px;padding:16px;background:var(--bg3);border-radius:8px;border:1px solid var(--border2)">
          ...
          <div class="fg">
            <div class="fi"><label class="fl">Subtitle <span class="tip">(small green label)</span></label><input class="fin slide-subtitle" value="${escH(s.subtitle || '')}"></div>
            <div class="fi full"><label class="fl">Headline <span class="tip">(use \\n for line breaks)</span></label><input class="fin slide-headline" value="${escH(s.headline || '')}"></div>
            <div class="fi full"><label class="fl">Description <span class="tip">(paragraph under headline)</span></label><textarea class="fta slide-description" style="min-height:60px">${escH(s.description || '')}</textarea></div>
            ...
            <div class="fi"><label class="fl">Button 1 Text</label><input class="fin slide-btnText" value="${escH(s.btnText || '')}"></div>
            <div class="fi"><label class="fl">Button 1 Subtext <span class="tip">(small grey line)</span></label><input class="fin slide-btnSubtext" value="${escH(s.btnSubtext || '')}"></div>
            <div class="fi full"><label class="fl">Button 1 URL</label><input class="fin slide-btnUrl" value="${escH(s.btnUrl || '')}"></div>
            ...
            <div class="fi"><label class="fl">Button 2 Text</label><input class="fin slide-btn2Text" value="${escH(s.btn2Text || '')}"></div>
            <div class="fi"><label class="fl">Button 2 Subtext <span class="tip">(small grey line)</span></label><input class="fin slide-btn2Subtext" value="${escH(s.btn2Subtext || '')}"></div>
            <div class="fi full"><label class="fl">Button 2 URL</label><input class="fin slide-btn2Url" value="${escH(s.btn2Url || '')}"></div>
          </div>
        </div>`).join('');
}
window.addSlide    = function() { const e = collectSlides(); e.push({subtitle:'',headline:'',description:'',btnText:'',btnSubtext:'',btnUrl:'',btn2Text:'',btn2Subtext:'',btn2Url:'',bgImage:''}); renderSlides(e); };
