...
def gen_index(data):
    ...
    for lang in SUPPORTED_LANGS:
        ...
        page = {
            ...
            "regionHreflang":  home_gf.get("regionHreflang") or "",
        }
...
def gen_catalog(data):
    ...
    for lang in SUPPORTED_LANGS:
        ...
        page = {
            ...
            "regionHreflang":  cat_gf.get("regionHreflang") or "",
        }
...
def gen_blog(data):
    ...
    for lang in SUPPORTED_LANGS:
        ...
        page = {
            ...
            "regionHreflang":  blog_gf.get("regionHreflang") or "",
        }
...
def gen_contacts(data):
    ...
    for lang in SUPPORTED_LANGS:
        ...
        page = {
            ...
            "regionHreflang":  cont_gf.get("regionHreflang") or "",
        }
...
def gen_sitemap(entries):
    ...
    for e in entries:
        ...
        for lang_var in langs:
            ...
            for l in langs:
                # regionHreflang applies only on the page whose lang == l
