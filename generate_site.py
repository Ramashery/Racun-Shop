...
def gen_index(data):
    ...
    # Словари UI для главной страницы (чтобы перевести кнопки)
    UI_STRINGS = {
        "en": {"viewAll": "View All Products", "buy": "Buy", "readArticle": "Read article", "allArticles": "All Articles"},
        "ru": {"viewAll": "Смотреть все товары", "buy": "Купить", "readArticle": "Читать статью", "allArticles": "Все статьи"},
        "ka": {"viewAll": "ყველა პროდუქტი", "buy": "ყიდვა", "readArticle": "წაკითხვა", "allArticles": "ყველა სტატია"},
        "hy": {"viewAll": "Դիտել բոլոր ապրանքները", "buy": "Գնել", "readArticle": "Կարդալ հոդվածը", "allArticles": "Բոլոր հոդվածները"},
    }
...
def gen_catalog(data):
    ...
    for lang in SUPPORTED_LANGS:
        ...
        page = {
            ...
            # Schema.org JSON-LD (CollectionPage) — хранится в globalFields.schemaOrg
...
def gen_contacts(data):
    ...
    UI_STRINGS = {
        "en": {
            "contactsLabel": "Where to buy", "contactsHeroSub": "RAKUN products are available in Armenia, Georgia and Belarus. Choose your country and find the nearest store.",
            "phone": "Phone", "email": "E-mail", "workingHours": "Working hours", "onlineStore": "Online store",
            "storesEyebrow": "Points of sale", "storesTitle": "Our <em>stores</em>", "storesSub": "Select a country to see store locations, addresses and working hours.",
            "georgia": "Georgia", "armenia": "Armenia", "belarus": "Belarus",
            "tbilisi": "Tbilisi", "yerevan": "Yerevan", "minsk": "Minsk",
            "connectEyebrow": "Connect with us", "connectTitle": "Write us <em>anywhere</em>", "connectSub": "We reply quickly. Choose the channel most convenient for you.",
            "howToOrderEyebrow": "How to buy", "howToOrderTitle": "Placing an <em>order</em>", "howToOrderSub": "It is easy to buy RAKUN products — choose any convenient method.",
            "step1Title": "Choose products", "step1Desc": "Browse our catalogue on the website or visit any of our partner stores and choose what you like.",
            "step2Title": "Contact us", "step2Desc": "Write to us in any messenger or call. We will help you confirm availability, size, and delivery details.",
            "step3Title": "Pay", "step3Desc": "We accept card and cash payment. For online orders — bank transfer or card via a secure link.",
            "step4Title": "Receive", "step4Desc": "Pick up from the store or get it delivered. We ship within the country and internationally.",
            "faqEyebrow": "FAQ", "faqTitle": "Frequently asked <em>questions</em>", "faqSub": "Everything you need to know about ordering, delivery and our stores.",
            "ctaEyebrow": "Ready to order?", "ctaButton": "Write on WhatsApp",
        },
        "ru": {
            "contactsLabel": "Где купить", "contactsHeroSub": "Продукция RAKUN доступна в Армении, Грузии и Беларуси. Выберите страну и найдите ближайший магазин.",
            "phone": "Телефон", "email": "E-mail", "workingHours": "Часы работы", "onlineStore": "Онлайн-магазин",
            "storesEyebrow": "Точки продаж", "storesTitle": "Наши <em>магазины</em>", "storesSub": "Выберите страну, чтобы увидеть адреса и часы работы магазинов.",
            "georgia": "Грузия", "armenia": "Армения", "belarus": "Беларусь",
            "tbilisi": "Тбилиси", "yerevan": "Ереван", "minsk": "Минск",
            "connectEyebrow": "Свяжитесь с нами", "connectTitle": "Пишите нам <em>везде</em>", "connectSub": "Мы отвечаем быстро. Выберите наиболее удобный для вас канал.",
            "howToOrderEyebrow": "Как купить", "howToOrderTitle": "Оформление <em>заказа</em>", "howToOrderSub": "Купить продукцию RAKUN легко — выберите любой удобный способ.",
            "step1Title": "Выберите товары", "step1Desc": "Ознакомьтесь с каталогом на сайте или посетите наши партнерские магазины.",
            "step2Title": "Свяжитесь с нами", "step2Desc": "Напишите в любой мессенджер или позвоните. Мы поможем с наличием и доставкой.",
            "step3Title": "Оплатите", "step3Desc": "Принимаем карты и наличные. Для онлайн-заказов — перевод или оплата по ссылке.",
            "step4Title": "Получите", "step4Desc": "Заберите из магазина или оформите доставку. Доставляем по городу и миру.",
            "faqEyebrow": "FAQ", "faqTitle": "Частые <em>вопросы</em>", "faqSub": "Всё, что нужно знать о заказе, доставке и наших магазинах.",
            "ctaEyebrow": "Готовы заказать?", "ctaButton": "Написать в WhatsApp",
        },
        "ka": {
            "contactsLabel": "სად ვიყიდოთ", "contactsHeroSub": "RAKUN პროდუქცია ხელმისაწვდომია სომხეთში, საქართველოში და ბელორუსში. აირჩიეთ თქვენი ქვეყანა.",
            "phone": "ტელეფონი", "email": "ელ. ფოსტა", "workingHours": "სამუშაო საათები", "onlineStore": "ონლაინ მაღაზია",
            "storesEyebrow": "გაყიდვის წერტილები", "storesTitle": "ჩვენი <em>მაღაზიები</em>", "storesSub": "აირჩიეთ ქვეყანა მისამართების სანახავად.",
            "georgia": "საქართველო", "armenia": "სომხეთი", "belarus": "ბელორუსია",
            "tbilisi": "თბილისი", "yerevan": "ერევანი", "minsk": "მინსკი",
            "connectEyebrow": "დაგვიკავშირდით", "connectTitle": "მოგვწერეთ <em>ნებისმიერგან</em>", "connectSub": "ჩვენ სწრაფად ვპასუხობთ.",
            "howToOrderEyebrow": "როგორ ვიყიდოთ", "howToOrderTitle": "შეკვეთის <em>გაფორმება</em>", "howToOrderSub": "RAKUN პროდუქციის შეძენა მარტივია.",
            "step1Title": "აირჩიეთ პროდუქცია", "step1Desc": "დაათვალიერეთ ჩვენი კატალოგი საიტზე ან ეწვიეთ მაღაზიებს.",
            "step2Title": "დაგვიკავშირდით", "step2Desc": "მოგვწერეთ მესენჯერში ან დაგვირეკეთ.",
            "step3Title": "გადაიხადეთ", "step3Desc": "ვიღებთ ბარათს და ნაღდ ფულს.",
            "step4Title": "მიიღეთ", "step4Desc": "აიღეთ მაღაზიიდან ან ისარგებლეთ მიტანის სერვისით.",
            "faqEyebrow": "FAQ", "faqTitle": "ხშირად დასმული <em>კითხვები</em>", "faqSub": "ყველაფერი მიტანის და შეკვეთის შესახებ.",
            "ctaEyebrow": "მზად ხართ შეკვეთისთვის?", "ctaButton": "მოგვწერეთ WhatsApp-ში",
        },
        "hy": {
            "contactsLabel": "Որտեղ գնել", "contactsHeroSub": "RAKUN արտադրանքը հասանելի է Հայաստանում, Վրաստանում և Բելառուսում:",
            "phone": "Հեռախոս", "email": "Էլ. փոստ", "workingHours": "Աշխատանքային ժամեր", "onlineStore": "Առցանց խանութ",
            "storesEyebrow": "Վաճառքի կետեր", "storesTitle": "Մեր <em>խանութները</em>", "storesSub": "Ընտրեք երկիրը հասցեները տեսնելու համար:",
            "georgia": "Վրաստան", "armenia": "Հայաստան", "belarus": "Բելառուս",
            "tbilisi": "Թբիլիսի", "yerevan": "Երևան", "minsk": "Մինսկ",
            "connectEyebrow": "Կապ մեզ հետ", "connectTitle": "Գրեք մեզ <em>ցանկացած տեղ</em>", "connectSub": "Մենք արագ ենք պատասխանում:",
            "howToOrderEyebrow": "Ինչպես գնել", "howToOrderTitle": "Պատվերի <em>ձևակերպում</em>", "howToOrderSub": "RAKUN գնելը հեշտ է:",
            "step1Title": "Ընտրեք ապրանքներ", "step1Desc": "Ծանոթացեք մեր տեսականուն կայքում կամ այցելեք խանութներ:",
            "step2Title": "Կապվեք մեզ հետ", "step2Desc": "Գրեք մեզ մեսենջերով կամ զանգահարեք:",
            "step3Title": "Վճարեք", "step3Desc": "Ընդունում ենք քարտ և կանխիկ:",
            "step4Title": "Ստացեք", "step4Desc": "Վերցրեք խանութից կամ պատվիրեք առաքում:",
            "faqEyebrow": "ՀՏՀ", "faqTitle": "Հաճախ տրվող <em>հարցեր</em>", "faqSub": "Ամեն ինչ պատվերի և առաքման մասին:",
            "ctaEyebrow": "Պատրա՞ստ եք պատվիրել:", "ctaButton": "Գրել WhatsApp-ում",
        },
    }
    ...
    for lang in SUPPORTED_LANGS:
        ...
        page = {
            ...
            "schemaOrg":       cont_gf.get("schemaJsonLd") or "",
        }

        stores = cont_gf.get("stores") or []
        ...
        write(f"{OUTPUT_DIR}/{lang}/contacts/index.html", html)
