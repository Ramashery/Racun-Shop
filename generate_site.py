...
try:
    ...
    NAV_STRINGS = {
        "en": {"home": "Home",     "about": "About us", "catalog": "Catalog", "blog": "Blog", "contacts": "Contacts"},
        "ru": {"home": "Главная",  "about": "О нас",    "catalog": "Каталог", "blog": "Блог", "contacts": "Контакты"},
        "ka": {"home": "მთავარი",  "about": "ჩვენ შესახებ", "catalog": "კატალოგი", "blog": "ბლოგი", "contacts": "კონტაქტი"},
        "hy": {"home": "Գլխավոր", "about": "Մեր մասին", "catalog": "Կատալոգ", "blog": "Բլոգ", "contacts": "Կոնտակտ"},
    }
    jinja.globals.update(BASE_URL=BASE_URL, LOGO_URL=LOGO_URL, SUPPORTED_LANGS=SUPPORTED_LANGS, NAV_STRINGS=NAV_STRINGS)
...
def gen_index(data):
    ...
    for lang in SUPPORTED_LANGS:
        ...
        html = T["index"].render(
            lang=lang,
            nav=NAV_STRINGS.get(lang, NAV_STRINGS["en"]),
            page=page,
            slides=slides,
            products=products,
            posts=posts,
